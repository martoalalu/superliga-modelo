...
# Función para test F mediante boostrap semiparamétrico
#
# In:
#    * datreg_M0: datos del modelo M0, supone que 'y' es var_dependiente
#    * datreg_M1: datos del modelo M1, supone que 'y' es var_dependiente
#    * B0: prediccion del modelo M0
#    * residuos_M1: residuos del modelo M1
#
# Out:
#    * Estadístico del test F bajo el supuesto de la hipótesis nula
#
